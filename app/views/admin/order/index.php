...
<body>
    ...
    <script>
        ...
        function ShowOrderDetails(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/dashboard/orders/view/" + id,
                success: function(response) {
                    ...
                    for (var i in books) {
                        ...
                        row.innerHTML = `<td><a href="<?php echo $_ENV['DOMAIN']; ?>/product/` + books[i]['id'] + `"><img src="` + books[i]['image'] + `">` + books[i]['title'] + `</td>` +
        ...
        function deleteOrder(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/dashboard/orders/destroy/" + id,
                success: function(response) {
        ...
        function confirmOrder(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/dashboard/orders/confirm/" + id,
                success: function(response) {
                    window.location.reload();
                }
            })
