                                            ...
                                            <tbody>
                                                <?php foreach ($books as $book) { ?>
                                                    <tr>
                                                        ...
                                                        <td><img style="border-radius: 0px" class="mr-2" src="<?php echo $book['image'] ?>"><a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $book['id'] ?>"><?php echo $book['title'] ?></a></td>
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="book-form" method="post" action="<?php echo $_ENV['DOMAIN']; ?>/dashboard/books/store" class="forms-sample">
                                        <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="category-form" method="post" action="<?php echo $_ENV['DOMAIN']; ?>/dashboard/books/addCategory" class="forms-sample">
                                        <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="supplier-form" method="post" action="<?php echo $_ENV['DOMAIN']; ?>/dashboard/books/addSupplier" class="forms-sample">
                                        <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="publisher-form" method="post" action="<?php echo $_ENV['DOMAIN']; ?>/dashboard/books/addPublisher" class="forms-sample">
                                        <div class="form-group">
        ...
        <script>
            ...
            function changeForm(action, json) {
                if (action == 'edit') {
                    ...
                    $('#book-form').attr('action', '<?php echo $_ENV['DOMAIN']; ?>/dashboard/books/update/' + book['id']);
                    ...
                    $('#book-form').attr('action', '<?php echo $_ENV['DOMAIN']; ?>/dashboard/books/store/');
            ...
            function deleteBook(id) {
                $.ajax({
                    url: "<?php echo $_ENV['DOMAIN']; ?>/dashboard/books/destroy/" + id,
