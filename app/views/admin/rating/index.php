...
<body>
                                                ...
                                                <?php foreach ($ratings as $rating) { ?>
                                                    <tr>
                                                        ...
                                                        <td><img class="mr-2" src="<?php echo $book['image'] ?>">
                                                            <a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $rating['book_id'] ?>"><?php echo $book['title'] ?></a>
                                                        </td>
    ...
    <script>
        ...
        function deleteRating(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/dashboard/ratings/destroy/" + id,
        ...
        function approveRating(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/dashboard/ratings/approve/" + id,
                success: function(response) {
                    window.location.reload();
                }
            })
