...
<body>
    ...
    <div id="menu" class="container bg-white row">
        ...
        <div class="col-sms-3 col-sm-3 col-md-3">
            <div class="menu-info">
                <a href="<?php echo $_ENV['DOMAIN']; ?>/category?c=Manga"><img src="https://cdn0.fahasa.com/media/wysiwyg/icon-menu/Icon_MangaCommic_8px_1.png" class="center"></a>
            </div>
            <div class="cms-icon-menu-item-name">Manga - Comic</div>
        </div>
        <div class="col-sms-3 col-sm-3 col-md-3">
            <div class="menu-info">
                <a href="<?php echo $_ENV['DOMAIN']; ?>/category?c=Kinh Tế"><img src="https://cdn0.fahasa.com/media/wysiwyg/icon-menu/ico_kinhte.png" class="center"></a>
            </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="truyen" style="display: flex;justify-content: center;">
                        <?php for ($i = 0; $i < 5; $i++) { ?>
                            <div class="book-item">
                                <a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $kt_books[$i]['id'] ?>">
                    ...
                    <div class="carousel-item">
                        <div class="truyen" style="display: flex; justify-content: center; ">
                            <?php for ($j = 0; $j < 5 && $i * 5 + $j < count($kt_books); $j++) { ?>
                                <div class="book-item">
                                    <a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $kt_books[$i * 5 + $j]['id'] ?>">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="truyen" style="display: flex;justify-content: center;">
                        <?php for ($i = 0; $i < 5; $i++) { ?>
                            <div class="book-item">
                                <a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $vh_books[$i]['id'] ?>">
                    ...
                    <div class="carousel-item">
                        <div class="truyen" style="display: flex; justify-content: center; ">
                            <?php for ($j = 0; $j < 5 && $i * 5 + $j < count($vh_books); $j++) { ?>
                                <div class="book-item">
                                    <a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $vh_books[$i * 5 + $j]['id'] ?>">
                ...
                <div class="carousel-item active">
                    <div class="truyen" style="display: flex;justify-content: center;">
                        <?php for ($i = 0; $i < 5 && $i < count($mg_books); $i++) { ?>
                            <div class="book-item">
                                <a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $mg_books[$i]['id'] ?>">
                    ...
                    <div class="carousel-item">
                        <div class="truyen" style="display: flex; justify-content: center; ">
                            <?php for ($j = 0; $j < 5 && $i * 5 + $j < count($mg_books); $j++) { ?>
                                <div class="book-item">
                                    <a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $mg_books[$i * 5 + $j]['id'] ?>">
