...
<body>
    ...
    <div class="cart-container">
        ...
        <div class="cart-ui-content row">
            ...
            align-items: center;">
                    ...
                    <a href="<?php echo $_ENV['DOMAIN']; ?>/category"><button class="shopping-btn" type="button">Mua sắm ngay</button></a>
                </div>
            <?php } else { ?>
                <div class="col-lg-8">
                        ...
                        <?php foreach ($cart as $id => $book) { ?>
                            <div class="item-book-cart">
                                ...
                                <div class="img-book-cart">
                                    <a class="book-image" href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $id ?>">
                                ...
                                <div class="group-book-info">
                                    <div class="info-book-cart">
                                        <div>
                                            <h2 class="book-name-full-text"><a href="<?php echo $_ENV['DOMAIN']; ?>/product/<?php echo $id ?>"><?php echo $book['title'] ?></a></h2>
                                        </div>
                    ...
                    <div class="block-total-cart">
                        ...
                        <div class="checkout-type-button-cart" style="text-align: center;">
                            <div class="method-button-cart">
                                <a href="<?php echo $_ENV['DOMAIN']; ?>/onestepcheckout">
    ...
    <script>
        function toggleCheckBook(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/cart/check",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function addQuantity(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/cart/add",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function subtractQuantity(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/cart/subtract",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function checkAll() {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/cart/checkall",
                type: 'post',
                data: {
        ...
        function deleteItem(id) {
            $.ajax({
                url: "<?php echo $_ENV['DOMAIN']; ?>/cart/delete",
                type: 'post',
                data: {
                    id: id,
                }
