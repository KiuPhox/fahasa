    ...
    <div class="account-container row">
            ...
            <div class="block-account">
                ...
                <div class="block-content">
                    <ul>
                        ...
                        <li class="current"><a href="<?php echo $_ENV['DOMAIN']; ?>/customer/account/edit">Thông tin tài khoản</a></li>
        ...
        <div class="col-main col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="my-account mb-4">
                ...
                <form id="form-account-info" method="post" action="<?php echo $_ENV['DOMAIN']; ?>/customer/account/editPost">
            ...
            <div class="my-account">
                ...
                <form id="form-account-info" method="post" action="<?php echo $_ENV['DOMAIN']; ?>/customer/account/updatePassword">
                    <div class="row align-items-center my-3">
